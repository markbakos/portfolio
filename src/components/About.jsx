        ...
        <>
            <div className="p-8 sm:p-14 w-[100vw] sm:w-[40vw] h-auto sm:h-[100vh] sm:fixed">
                ...
                <div className="flex flex-row items-center">
                    <button
                        className="h-8 w-[8rem] flex flex-row justify-center items-center mr-5 font-medium border rounded-sm hover:bg-white hover:text-black transition">
                        <svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 384 512"
                             className="mr-2" height="18" width="18" xmlns="http://www.w3.org/2000/svg">
                            <path
